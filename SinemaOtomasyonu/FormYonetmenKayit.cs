    ...
    public partial class FormYonetmenKayit : Form
    {
        ...
        private void buttonKayitTamamla_Click(object sender, EventArgs e)
        {
            ...
            if (textAd.Text!= "" && textSoyad.Text!= "" && textBoxBiyografi.Text!= "" && resimYolu!="")
            {
                ...
                conn.Open();
                SqlCommand command = new SqlCommand("INSERT INTO TB_Yonetmenler (AdSoyad,Cinsiyet,Yas,Biyografi,Resim) VALUES (@adsoyad,@cinsiyet,@yas,@biyografi,@resim)", conn);
                ...
                conn.Close();
                MessageBox.Show("YONETMEN KAYIT ISLEMI BASARILI BIR SEKILDE GERCEKLESTIRILDI !");
                aracTemizleme();
            }
            else
            {
